...
Every formula is written out in docs/formulas.md.
Findings
...
Attribution
The dataset and original project concept come from Mo Chen's excel-project-coffee-sales. The workbook was rebuilt independently; the data quality checks, documentation, findings and recommendations in this repository are my own.
About me
...
LinkedIn: linkedin.com/in/nagendrakumartripathi
